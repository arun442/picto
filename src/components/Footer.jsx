...
>Services</button></li> */}
          ...
          {/* <div>
            <h4 className="text-sm tracking-wide mb-6">SUPPORT</h4>
            <ul className="space-y-3">
              <li><Link href="#" className="text-[#B4AFA5] hover:text-white transition-colors">FAQ</Link></li>
              <li><Link href="#" className="text-[#B4AFA5] hover:text-white transition-colors">Shipping</Link></li>
              <li><Link href="#" className="text-[#B4AFA5] hover:text-white transition-colors">Returns</Link></li>
            </ul>
          </div> */}
